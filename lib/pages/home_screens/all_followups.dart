...
class _AddFollowupsState extends State<AddFollowups> {
  ...
  Future<void> fetchTasks() async {
    ...
    final String apiUrl =
        "https://api.smartassistapp.in/api/admin/leads/tasks/all/9b1e2e9c-f9a8-4b33-ab07-6e94a6a86862";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        print('this is the url $apiUrl');
        final Map<String, dynamic> data = json.decode(response.body);

        setState(() {
          allTasks = data['allTasks']?['rows'] ?? [];
  ...
  Widget _getCurrentWidget() {
    if (_upcommingButtonIndex == 0) {
      // Show both upcoming and overdue tasks for "All"
      return Column(
        children: [
          FollowupsUpcoming(
